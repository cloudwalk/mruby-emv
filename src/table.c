...
mrb_table_init(mrb_state* mrb)
{
  ...
  mrb_define_class_method(mrb , table , "_init"   , mrb_emv_table_s_init   , MRB_ARGS_REQ(1));
  mrb_define_class_method(mrb , table , "_rec"    , mrb_emv_table_s_rec    , MRB_ARGS_REQ(1));
  mrb_define_class_method(mrb , table , "_fin"    , mrb_emv_table_s_fin    , MRB_ARGS_NONE());
  mrb_define_class_method(mrb , table , "_change" , mrb_emv_table_s_change , MRB_ARGS_REQ(1));
}
